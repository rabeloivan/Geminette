...
def run_C00_ex06(student_file):
	...
	expected = generate_comb2_output()
	...
	if actual == expected:
		print_test_pass(1, f"ft_print_comb2() output {disp_act} as expected")
		passed = True
	else:
		print_test_fail(1, f"ft_print_comb2() output {disp_act} but expected {disp_exp}")
